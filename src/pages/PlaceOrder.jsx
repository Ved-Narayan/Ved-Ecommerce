...
const PlaceOrder = () => {
  ...
  //this helps in knowing which payment updation 
  const [method,setMethod] = useState('cod');


  //for navigation to orders page when place order is clicked
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3 '>
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='number' placeholder='Zip code' ></input>
